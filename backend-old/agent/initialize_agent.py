...
# from langchain_openai import ChatOpenAI # REMOVE THIS
...
def initialize_agent():
    """Initialize the agent with CDP Agentkit."""
    # Initialize LLM.
    # llm = ChatOpenAI(model=constants.AGENT_MODEL) # REMOVE THIS
    llm = ChatGoogleGenerativeAI(model=constants.AGENT_MODEL, google_api_key=os.getenv("GOOGLE_API_KEY")) # ADD THIS
